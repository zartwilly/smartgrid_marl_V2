...
def execute_algos_used_Generated_instances_N_INSTANCES(arr_pl_M_T_vars_init,
    ...
    for (algo_name, (pi_hp_plus_elt, pi_hp_minus_elt), 
        ...
        # # list of columns Cx, x = {1, ..., 7}
        # Cx = dict()
        # C1 = None; C1 = True if dico_profils_NH["nb_profils"] > 0 else False
        # C2 = None; C2 = True if k_stop_learning_LRI2 < k_steps else False
        # C3 = None; 
        # if C1 and C2:
        #     if profils_stabilisation_LRI2 in dico_profils_NH["profils"]:
        #         C3 = True
        #     elif profils_stabilisation_LRI2 not in dico_profils_NH["profils"]:
        #         C3 = False
        # C4 = None; C4 = k_stop_learning_LRI2 if C2 else None
        # C5 = Perf_sum_Vi_LRI2
        # C6 = dico_best_profils_bf["Perfs"][0] \
        #         if dico_best_profils_bf["nb_best_profils"] == 0 else None
        # C7 = None
        # if C1:
        #     C7 = dico_bad_profils_NH["Perfs"][0] \
        #         if dico_bad_profils_NH["nb_bad_profils"] > 0 else None
        # Cx={"C1":C1, "C2":C2, "C3":C3, "C4":C4, "C5":C5, "C6":C6, "C7":C7}
